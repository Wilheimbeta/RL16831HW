...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        if itr == 0 and load_initial_expertdata is not None:
            ...
            loaded_paths = load_initial_expertdata
            return loaded_paths, 0, None
        ...
        paths, envsteps_this_batch = self.params['batch_size'], self.params['ep_len']
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        paths = []
        for path in paths:
            path["action"] = self.policy.get_action(path["observation"])
            paths.append(path)
        return paths
